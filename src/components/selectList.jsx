                ...
                <div className='row'>
                    ...
                    <div className='col-md-3 col-12 mobile-list position-relative pe-5 '>
                        <div className='d-flex justify-content-center align-items-center m-4 m-md-0 selectBox'>
                            <div className='d-inline-block me-2  '><IoBagRemoveSharp className='selectIcon-with-circle mb-1 d-inline-block'/></div>
                            <select className="bg-transparent form-select selecteList m-0 d-inline-block text-white p-0" aria-label="Default select example">
                                <option selected className='bg-secondaryColor-op p-2'>Experience</option>
                            </select>
                            <span className='arrow  d-inline-block mt-2'></span>
                        </div>
                    </div>
